...
#### Using the `bal consolidate-packages` command
Alternatively, users can install the `consolidate-packages` tool and use CLI commands to create and modify the consolidator package.
